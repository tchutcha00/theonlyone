local config = {
hnitem = "Você precisa de 1 castle voucher para entrar no Devil Castle.", --Mensagem que o player receberá caso não tenha o item.
hitem = "Você entrou no Devil Castle.", --Mensagem que o player receberá caso tenha o item.
item = 5957, --ID do item.
qnt = 1, --Quantidade.
pos = {x = 963, y = 1118, z = 6}, --Coordenada para onde o jogador será teleportado caso o player tenha o item.
pos2 = {x = 1095, y = 1061, z = 8}, --Coordenada para onde o jogador será teleportado caso player não tenha o item.
}
