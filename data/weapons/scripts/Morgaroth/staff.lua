...
addDamageCondition(condition, 8, 600, -5200)
addDamageCondition(condition, 8, 600, -5200)
...
doSendAnimatedText(getPlayerPosition(cid),"BURNING!", TEXTCOLOR_ORANGE)
...
doPlayerSendTextMessage(cid, MESSAGE_EVENT_DEFAULT, "[WEAPON MENSSAGE] - Health mana de (2%) efetuado ao seu character!")
