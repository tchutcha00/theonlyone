...
addDamageCondition(condition, 6, 600, -4000)
addDamageCondition(condition, 6, 600, -4000)
...
doCombat(cid, combat, var)
doCreatureAddHealth(cid, getCreatureMaxHealth(cid)*0.06)
doPlayerAddMana(cid, getCreatureMaxMana(cid)*0.06)
doPlayerSendTextMessage(cid, MESSAGE_EVENT_DEFAULT, "[WEAPON MENSSAGE] - Health life e mana de (6%) efetuado ao seu character!")
