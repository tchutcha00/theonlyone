...
function onCastSpell(cid, var)
        doPlayerSendTextMessage(cid,27,"EFEITO MÁGICO: Ataque divino de flecha furiosa foi ativado, afetando o inimigo múltiplas vezes (3x). O cálculo do dano é baseado em seu nível de skills e ataque da arma.")
