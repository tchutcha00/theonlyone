...
npcHandler:setMessage(MESSAGE_GREET, "Olá |PLAYERNAME|. Gostaria de informações sobre os Village Coins ? Diga {village}.")
...
keywordHandler:addKeyword({'village'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = false, text = 'Os Village Coins são moedas de trocas, que podem ser trocados por items Village nos baús desta sala (items extremamente poderosos necessitam de nivel 180+ para usá-los). Os village coins são obtidos na quest nivel 180+ (localizada no templo, quest extremamente difícil). Recomendo a você não ir sozinho, ir com no minímo 5 amigos, caso contrario a chance de sucesso é mínima!'})
