...
npcHandler:setMessage(MESSAGE_GREET, "Olá |PLAYERNAME|. Gostaria de informações sobre refinamento de items? Diga {refinamento}.")
...
keywordHandler:addKeyword({'refinamento'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = false, text = 'As pedras de refinamento são retiradas minerando, usando uma picareta (se obtém na quest nível 130) em uma das pedras coloridas, como estas ao meu lado. Existem ao todo 6 pedras de refinamento que melhoram suas armas ou armaduras, aumentando o ataque ou a defesa. Para obter informações sobre as pedras de refinamento diga {pedras}.'})
keywordHandler:addKeyword({'pedras'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = false, text = 'As pedras de refinamento possuem suas porcentagens (Bônus) de refinar seus items de +1 até +15, quanto maior o nível do seu item, melhor ele ficará. As pedras são; pedra refinadora nível 1 (Bônus +0%); pedra refinadora nível 2 (Bônus +5%); pedra refinadora nível 3 (Bônus +10%); pedra refinadora nível 4 (Bônus +15%); pedra refinadora nível 5 (Bônus +20%); pedra refinadora nível 6 (Bônus +25%, se obtém na Anihilation Quest).'})
