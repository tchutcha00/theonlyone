...
npcHandler:setMessage(MESSAGE_GREET, "Olá |PLAYERNAME|. Gostaria de informações sobre invasões? Diga {invasoes}.")
...
keywordHandler:addKeyword({'invasoes'}, StdModule.say, {npcHandler = npcHandler, onlyFocus = false, text = 'As invasões acontecem aleatoriamente e automaticamente na cidade de Carlin, os monstros possuem XP e Hits variados, sendo eles: Mercenários, Saqueadores, Exterminadores e Ferumbras. Seguem esta ordem de XP, Baixa > Alta.'})
