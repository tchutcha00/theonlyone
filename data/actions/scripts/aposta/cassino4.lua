-- config by notle
money,x2 = 500000,true --[dinheiro para jogar] pra deixa mais facil deixa true que ate duas combinação ganha premio na metade e se cair 3x ganha o premio mais metade
local t = {
{2674,premio=2160,pre_cont=100}, -- aqui tenta fazer combinação  se sair 3x 2674 vai ganhar 2160,10 ou 2x 2674 vai ganhar 2160,5
{8841,premio=2159,pre_cont=1}}
-- config by notle
function onUse(cid, item, frompos, item2, topos)
pos1 = {x=1088, y=1080, z=9, stackpos=1} -- aqui coloca os lugar q vai criar os 3 item e vai tentar fazer combinação  coloca posição x,y,z
pos2 = {x=1089, y=1080, z=9, stackpos=1}
pos3 = {x=1090, y=1080, z=9, stackpos=1}
...
if getPlayerStorageValue(cid, 788526) >= os.time() then return true end
...
setPlayerStorageValue(cid, 788526, os.time() +2)
